...
class ChatBoxSearchScreen extends StatefulWidget {
  const ChatBoxSearchScreen({Key? key}) : super(key: key);

  @override
  State<ChatBoxSearchScreen> createState() =>
      _ChatBoxSearchScreenState();
}

class _ChatBoxSearchScreenState extends State<ChatBoxSearchScreen>
    with SingleTickerProviderStateMixin {
  late ChatBoxSearchViewModel _viewModel;
  ...
  Widget build(BuildContext context) {
    return BaseWidget<ChatBoxSearchViewModel>(
        viewModel: ChatBoxSearchViewModel(),
