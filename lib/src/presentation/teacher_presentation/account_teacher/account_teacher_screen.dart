...
class AccountTeacherScreen extends StatefulWidget {
  const AccountTeacherScreen({Key? key}) : super(key: key);

  @override
  State<AccountTeacherScreen> createState() => _AccountTeacherScreenState();
}

class _AccountTeacherScreenState extends State<AccountTeacherScreen> {
  late AccountTeacherViewModel _viewModel;

  @override
  Widget build(BuildContext context) {
    return BaseWidget<AccountTeacherViewModel>(
        viewModel: AccountTeacherViewModel(),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: ValueListenableBuilder<TeacherModel?>(valueListenable: _viewModel.teacher, builder: (context, teacher, child) => ClipRRect(
          ...
          SizedBox(width: 16),
          Expanded(
            child: ValueListenableBuilder(valueListenable: _viewModel.teacher, builder: (context, teacher, child) => Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(
                  teacher?.fullName ?? '',
