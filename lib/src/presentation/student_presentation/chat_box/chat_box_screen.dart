...
import 'package:lms/src/presentation/student_presentation/chat_box/show_create_chat_bottom_sheet.dart';
...
class _ChatBoxScreenState extends State<ChatBoxScreen> {
  late ChatBoxViewModel _viewModel;
  ...
  Widget build(BuildContext context) {
    return BaseWidget<ChatBoxViewModel>(
