...
class Routers {
  ...
  static const String allRequestJoinCourseByStudent = "/all-request-join-course-by-student";
  static const String testDetail = "/test-detail";
  static const String testResult = "/test-result";
  static const String chatBoxDetail = "/chat-box-detail";
  static const String chatBoxInfo = "/chat-box-info";
  static const String chatBoxSearch = "/chat-box-search";
  static const String chatBoxMember = "/chat-box-member";
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      case navigation:
        return animRoute(const NavigationScreen(), name: navigation, beginOffset: _right, arguments: arguments);
      case welcome:
        return animRoute(const WelcomeScreen(), name: welcome, beginOffset: _right, arguments: arguments);
      case chooseRole:
        return animRoute(const ChooseRoleScreen(), name: chooseRole, beginOffset: _right, arguments: arguments);
      case login:
        return animRoute(const LoginScreen(), name: login, beginOffset: _right, arguments: arguments);
      case register:
        return animRoute(const RegisterScreen(), name: register, beginOffset: _right, arguments: arguments);
      case course:
        return animRoute(const CourseScreen(), name: course, beginOffset: _right, arguments: arguments);
      case search:
        return animRoute(const SearchScreen(), name: search, beginOffset: _right, arguments: arguments);
      case courseReview:
      ...
      case support:
        return animRoute(const SupportScreen(), name: support, beginOffset: _right, arguments: arguments);
      case changePassword:
        return animRoute(const ChangePasswordScreen(), name: changePassword, beginOffset: _right, arguments: arguments);
      case forgotPassword:
        return animRoute(const ForgotPasswordScreen(), name: forgotPassword, beginOffset: _right, arguments: arguments);
      ...
      case otp:
        return animRoute(const OtpScreen(), name: otp, beginOffset: _right, arguments: arguments);
      case groupDetail:
        return animRoute(const GroupDetailScreen(), name: groupDetail, beginOffset: _right, arguments: arguments);
      case socketChatBox:
        return animRoute(const SocketChatBoxScreen(), name: socketChatBox, beginOffset: _right, arguments: arguments);
      case allRequestJoinCourseByStudent:
        return animRoute(const AllRequestJoinCourseScreen(),
            name: allRequestJoinCourseByStudent, beginOffset: _right, arguments: arguments);
      case testDetail:
        return animRoute(const TestDetailScreen(), name: testDetail, beginOffset: _right, arguments: arguments);
      case testResult:
        return animRoute(const TestResultScreen(), name: testResult, beginOffset: _right, arguments: arguments);
      case chatBoxDetail:
        return animRoute(const ChatBoxDetailScreen(), name: chatBoxDetail, beginOffset: _right, arguments: arguments);
      case chatBoxInfo:
        return animRoute(const ChatBoxInfoScreen(), name: chatBoxInfo, beginOffset: _right, arguments: arguments);
      case chatBoxSearch:
        return animRoute(const ChatBoxSearchScreen(), name: chatBoxSearch, beginOffset: _right, arguments: arguments);
      case chatBoxMember:
        return animRoute(const ChatBoxMemberScreen(), name: chatBoxMember, beginOffset: _right, arguments: arguments);
      case paymentWebView:
        return animRoute(const PaymentWebViewScreen(), name: paymentWebView, beginOffset: _right, arguments: arguments);
      ...
      case loginTeacher:
        return animRoute(const LoginTeacherScreen(), name: loginTeacher, beginOffset: _right, arguments: arguments);
      ...
      case notificationDetailTeacher:
        return animRoute(const NotificationDetailTeacherScreen(),
            name: notificationDetailTeacher, beginOffset: _right, arguments: arguments);
      case editProfileTeacher:
        return animRoute(const EditProfileTeacherScreen(),
            name: editProfileTeacher, beginOffset: _right, arguments: arguments);
      case changePasswordTeacher:
        return animRoute(const ChangePasswordTeacherScreen(),
            name: changePasswordTeacher, beginOffset: _right, arguments: arguments);
      case createCourse:
        return animRoute(const CreateCourseScreen(), name: createCourse, beginOffset: _right, arguments: arguments);
      case courseDetailTeacher:
        return animRoute(const CourseDetailTeacherScreen(),
            name: courseDetailTeacher, beginOffset: _right, arguments: arguments);
      case courseFileDetailTeacher:
        return animRoute(const CourseFileDetailTeacherScreen(),
            name: courseFileDetailTeacher, beginOffset: _right, arguments: arguments);
      case courseMaterialDetailTeacher:
        return animRoute(const CourseMaterialDetailTeacherScreen(),
            name: courseMaterialDetailTeacher, beginOffset: _right, arguments: arguments);
      ...
      case createTest:
        return animRoute(const CreateTestScreen(), name: createTest, beginOffset: _right, arguments: arguments);
      case editTest:
        return animRoute(const EditTestScreen(), name: editTest, beginOffset: _right, arguments: arguments);
      ...
      case chatBoxInfoTeacher:
        return animRoute(const ChatBoxInfoTeacherScreen(),
            name: chatBoxInfoTeacher, beginOffset: _right, arguments: arguments);
      case chatBoxMemberTeacher:
        return animRoute(const ChatBoxMemberTeacherScreen(),
            name: chatBoxMemberTeacher, beginOffset: _right, arguments: arguments);
      case chatBoxSearchTeacher:
        return animRoute(const ChatBoxSearchTeacherScreen(),
            name: chatBoxSearchTeacher, beginOffset: _right, arguments: arguments);
      //case default
      default:
  ...
  static Route animRoute(Widget page, {Offset? beginOffset, required String name, Object? arguments}) {
