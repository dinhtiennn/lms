...
void showCreateChatBottomSheet(
    BuildContext context, ChatBoxTeacherViewModel viewModel) {
                        ...
                        child: Padding(
                          ...
                          child: WidgetInput(
                            ...
                            validator: AppValid.validateRequireEnter(
                                titleValid: 'Vui lòng nhập tên nhóm'),
                          ),
                        ),
                      ),
                            ...
                            return ElevatedButton(
                              onPressed: () {
                                ...
                                if (selected.length < 2) {
                                  viewModel.showToast(
                                      title:
                                          'Số người trong nhóm không được bé hơn 2',
                                ...
                                final List<AccountModel> members = selected
                                    .map((user) => user)
                                    .where((user) =>
                                        (user.accountUsername ?? '').isNotEmpty)
                                    .toList();
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    selected.isEmpty ? Colors.grey : primary2,
                                padding:
